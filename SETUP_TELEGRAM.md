...
```
~/claude-work/warroom/bin/warroom-say "[Air-Codex] claiming T-002, starting the implementation"
```
(or add `bin/` to PATH and just `warroom-say "..."`)

Use it to: announce online, claim a task, hand off ("done, @Air-Claude your turn"), ask, escalate.
